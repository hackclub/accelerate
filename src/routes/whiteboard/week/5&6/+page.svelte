<script>
    ...
    onMount(() => {
        const targetDate = new Date('2025-12-16T00:00:00-05:00'); // December 16, 2025, 12:00 AM EST
...
<div>
    ...
    <iframe 
        src="https://o80g48ksccg8888so4gk00cs.a.selfhosted.hackclub.com" 
        class="absolute w-3/4 h-[75vh] overflow-hidden scale-50 z-40 -right-100 -translate-y-25 drop-shadow-6xl" 
        scrolling="no"
        title="Simulation"
    ></iframe><div class={expanded
        ...
        <iframe
            src="/Weeks_5_6__Projectile_Motion.pdf"
    ...
    <p class = "absolute bottom-42 left-100 text-xl font-pangolin">
        ...
        This week you're challenged to build your own Projectile simulation! <br>
        ...
        <span class="relative left-10 text-2xl font-pangolin">You included wind?</span><br>
        <span class="relative left-10 text-2xl font-pangolin">You made a naval warfare game simulating the cannons as projectiles?</span><br>
        <span class="relative left-10 text-2xl font-pangolin">You made a fighter pilot sim, shooting projectiles?</span><br>
        <span class="relative left-10 text-2xl font-pangolin">There were mid-air collisions?</span><br>
        <span class="relative left-10 text-2xl font-pangolin">The projectiles had different sounds for their parabolas?</span>
    </p>
    <button class="absolute bottom-10 left-120 hover:cursor-pointer" onclick={() => window.location.replace("/whiteboard/week/5%266/submit")} onmouseenter={() => (hoverSubmit = true)} onmouseleave={() => (hoverSubmit = false)}>
