<script>
    ...
    onMount(() => {
        const targetDate = new Date('2026-01-13T00:00:00-05:00'); 
...
<div>
    ...
    <iframe 
        ...
        class="absolute w-3/4 h-[75vh] overflow-hidden scale-70 z-40 -right-100 -translate-y-25 drop-shadow-6xl" 
        scrolling="no"
        title="Simulation"
    ></iframe>
    ...
    <p class = "absolute bottom-42 left-100 text-xl font-pangolin">
        ...
        This week you're challenged to build your own Fluid Dynamics simulation! <br>
        ...
        <span class="relative left-10 text-2xl font-pangolin">You made a wave pool?</span><br>
        <span class="relative left-10 text-2xl font-pangolin">There was a boat floating on the water?</span><br>
        <span class="relative left-10 text-2xl font-pangolin">There was rain?</span><br>
        <span class="relative left-10 text-2xl font-pangolin">There was a high-pressure pipe?</span><br>
        <span class="relative left-10 text-2xl font-pangolin">There were underwater obstacles?</span>
    </p>
    <button class="absolute bottom-10 left-120 hover:cursor-pointer" onclick={() => window.location.replace("/whiteboard/week/9%2610/submit")} onmouseenter={() => (hoverSubmit = true)} onmouseleave={() => (hoverSubmit = false)}>
